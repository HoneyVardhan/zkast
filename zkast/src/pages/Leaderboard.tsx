...
export default function Leaderboard() {
  ...
  if (displayEntries.length === 0) {
    return (
      <div className="container mx-auto px-4 py-8 max-w-2xl flex flex-col items-center justify-center min-h-[50vh] animate-fade-in">
        <Trophy className="h-12 w-12 text-muted-foreground mb-4 opacity-20" />
        <h2 className="text-lg font-bold mb-2">No Rankings Yet</h2>
        <p className="text-sm text-muted-foreground mb-6">The competition is just getting started!</p>
        <Link to="/">
          <Button className="rounded-xl px-8 h-10">Explore Markets</Button>
        </Link>
      </div>
    );
  }
